...
export function IconPothole({ className, style  }: IconProps) {
  return (
...
export function IconGraffiti({ className, style  }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style} {...stroke}>
...
export function IconDumping({ className, style  }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style}{...stroke}>
...
export function IconPlayground({ className, style  }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className}style={style} {...stroke}>
      <path d="M12 3v18" />
...
export function IconStreetlight({ className , style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style} {...stroke}>
      <path d="M10 21h4" />
      <path d="M12 21V9" />
...
export function IconVegetation({ className, style  }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style} {...stroke}>
      <path d="M12 21V10" />
...
export function IconWaterLeak({ className, style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style} {...stroke}>
...
export function IconFootpath({ className , style }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} style={style} {...stroke}>
